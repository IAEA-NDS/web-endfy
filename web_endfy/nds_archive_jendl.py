...
def create_jendl_pd_2016_library_list(cache_dir):
    jendl_pd_2016_list = []
    for sublib in ('g',):
...
def create_jendl_pd_2016_1_library_list(cache_dir):
...
def create_jendl_he_2007_library_list(cache_dir):
    jendl_he_2007_list = []
    for sublib in ('n', 'p'):
...
def create_jendl40_he_library_list(cache_dir):
    jendl40_he_list = []
    for sublib in ('n', 'p'):
...
def create_jendl_deu_2020_library_list(cache_dir):
    jendl_deu_2020_list = []
    for sublib in ('d',):
...
def create_jendl_ad_2017_library_list(cache_dir):
    jendl_ad_2017_list = []
    for sublib in ('n', 'p'):
...
def create_jendl32_library_list(cache_dir):
    jendl32_list = []
...
def create_jendl33_library_list(cache_dir):
    jendl33_list = []
    for sublib in ('n', 'nfpy'):
        jendl33_list.append(
            EndfArchiveDownloader(
...
def create_jendl40_library_list(cache_dir):
    jendl40_list = []
...
def create_jendl5_library_list(cache_dir):
    jendl50_list = []
...
def create_jendl_library_list(cache_dir=None):
    jendl_list = []
    jendl_list.extend(create_jendl_pd_2016_library_list(cache_dir))
    jendl_list.extend(create_jendl_pd_2016_1_library_list(cache_dir))
    jendl_list.extend(create_jendl_he_2007_library_list(cache_dir))
    jendl_list.extend(create_jendl40_he_library_list(cache_dir))
    jendl_list.extend(create_jendl_deu_2020_library_list(cache_dir))
    jendl_list.extend(create_jendl_ad_2017_library_list(cache_dir))
    jendl_list.extend(create_jendl32_library_list(cache_dir))
    jendl_list.extend(create_jendl33_library_list(cache_dir))
    jendl_list.extend(create_jendl40_library_list(cache_dir))
    jendl_list.extend(create_jendl5_library_list(cache_dir))
    return jendl_list
