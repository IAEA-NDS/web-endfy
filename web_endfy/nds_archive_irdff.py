...
def create_irdff1_library_list(cache_dir):
    irdff_list = []
    for sublib in ('n',):
        irdff_list.append(
...
def create_irdff2_library_list(cache_dir):
    irdff2_list = []
    for sublib in ('n',):
        irdff2_list.append(
            EndfArchiveDownloader(
...
def create_irdff_library_list(cache_dir=None):
    irdff_list = []
    irdff_list.extend(create_irdff1_library_list(cache_dir))
    irdff_list.extend(create_irdff2_library_list(cache_dir))
    return irdff_list
